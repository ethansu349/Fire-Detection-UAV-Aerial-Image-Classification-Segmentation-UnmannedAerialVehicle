...
config_segmentation = {"batch_size": 16, 'Save_Model': True, 'Epochs': 30, "TrainingPlot": True,
                       "train_set_ratio": 0.85, "val_set_ratio": 0.15, "num_class": 2, "CHANNELS": 5, 
                       "Merge_mode": True, "Test_mode": False, 
